...
import (
	...
	"github.com/ck3g/SomeDaysOfGo/build-your-own-x/wtf-dial/http"
	"github.com/ck3g/SomeDaysOfGo/build-your-own-x/wtf-dial/mock"
)
...
// Ensure service return an error if an internal error occurs.
