...
// in the browser window by setting content dispostion. It also allows specification of the display name.
...
// WriteJSON takes a response status code and arbitrary data writes json to the client
...
// The final parameter, client, is optional. If none is specifie, we use the standard http.Client.
